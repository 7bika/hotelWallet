...
module.exports = class Email {
  ...
  async sendWelcome() {
    await this.send('welcome', 'Welcome with us !')
  }
...
exports.sendEmail = async (options) => { // ! options : the email address we want to send an email to , the subject line, the email content 

   // ! 1) create a transporter : service that will send the email
   const transporter = nodemailer.createTransport({ // options in there
